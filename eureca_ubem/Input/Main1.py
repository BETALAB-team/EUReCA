...
geojson_files = [os.path.splitext(file)[0] for file in files_in_directory if file.endswith('.geojson')]


city_model_file = os.path.join("Gas"+".geojson")
city_geojson = City(
       ...
       epw_weather_file=weather_file,
        ...
        building_model = "2C",
        output_folder=os.path.join(".","Gass")
    )
