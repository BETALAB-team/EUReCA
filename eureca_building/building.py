...
""")
    ...
    def simulate(self,
        ...
        total["Grid  CO2 Emission Scope 2 [kg CO2]"]=1.95 * 612 / 277778000 * total["Taken from the Gird [kWh]",f"Bd {self.name}"]*60
        ...
        total["Grid  CO2 Emission Scope 3 [kg CO2]"]=0.2* 1.95 * 612 / 277778000 * total["Taken from the Gird [kWh]",f"Bd {self.name}"]*60
