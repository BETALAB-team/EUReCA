...
"""
def create_shading_horizon(surfaces):
   ...
   for surface_index in range(len(surfaces)):
       #set up the current surface that is going to be analyzed
        surface_to_calculate=surfaces[surface_index]
        ...
        shader_surfaces=[shader_surfaces[tree_index] for tree_index in indices_list[surface_index]]
        ...
        for shading_surface_index in range(len(shader_surfaces)):
            ...
            #point being studied
            shading_surface_vertices_relative=[array-point_to_calculate for array in shading_surface_vertices_interpolated]
