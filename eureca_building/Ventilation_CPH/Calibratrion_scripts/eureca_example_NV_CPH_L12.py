...
def simulation(
    ...
    wall_North = Surface(
        "Wall North",
        vertices=((0., 12.3, 12.), (0., 12.3, 14.7), (8.7, 12.3, 14.7), (8.7, 12.3, 12.)),  # The third coordinate takes into account the flat floor number (each floor of 3.0 m - external dimensions)
        wwr=0.35,
    ...
    wall_South = Surface(
        "Wall South",
        vertices=((0., 0., 12.), (8.7, 0., 12.), (8.7, 0., 14.7), (0., 0., 14.7)),  # The third coordinate takes into account the flat floor number (each floor of 3.0 m - external dimensions)
        wwr=0.47,
        surface_type="ExtWall",
    ...
    roof = Surface(
        "Roof",
        vertices=((0., 0., 14.7), (8.7, 0., 14.7), (8.7, 4.2, 14.7), (7.2, 4.2, 14.7), (7.2, 8.5, 14.7), (7.8, 8.5, 14.7), (7.8, 10.5, 14.7), (8.7, 10.5, 14.7), (8.7, 12.3, 14.7), (0., 12.3, 14.7)),
        wwr=0,
        surface_type="Roof",
    ...
    int_part = SurfaceInternalMass(
        "IntPart",
        area=194,     # Area is doubled since partitions inside the occupied zone present two surfaces
        surface_type="IntWall",
    ...
    int_floor = SurfaceInternalMass(
        "IntFloor",
        area=94,  # Floor area based the average value between internal and external dimensions
    ...
    tz1 = ThermalZone(
        name="Zone 1",
        surface_list=[wall_North, wall_South, roof, int_wall, int_part, int_floor],
    ...
    bd = Building("BdL12", thermal_zones_list=[tz1], model = "1C")
...
#########################################################
# Measure loading
measure = pd.read_csv("C:\\Users\\gecky\\OneDrive - Università degli Studi di Padova\\PhD_directory\\AAU material\\DataComfortCooling\\1_Collected_data\\IC-Meter-QRFB36035F-Indoor-Minutes-01-Jun-2023-29-Oct-2023.csv",
                      skiprows = 0, header = 1, delimiter = ';', decimal = ',', index_col = 0, parse_dates = True)
measure.drop(["DATE (EUROPE/COPENHAGEN)", "TIME (EUROPE/COPENHAGEN)"], axis = 1, inplace = True)
...
output_file_name = "Calibration_results_L12"
