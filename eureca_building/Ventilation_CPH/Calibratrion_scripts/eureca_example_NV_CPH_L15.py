...
def simulation(
    ...
    int_part = SurfaceInternalMass(
        "IntPart",
        area=114,     # Area is doubled since partitions inside the occupied zone present two surfaces
        surface_type="IntWall",
    ...
    int_ceil = SurfaceInternalMass(
        "IntCeil",
        area=35,  # Ceiling area based the average value between internal and external dimensions
    ...
    tz1 = ThermalZone(
        name="Zone 1",
        surface_list=[wall_North, wall_South, roof_N, int_wall, int_part, int_floor, int_ceil],
        net_floor_area=61, # Net floor area based on internal dimensions
        volume=61*2.7)
    ...
    bd = Building("BdL15", thermal_zones_list=[tz1], model = "1C")
