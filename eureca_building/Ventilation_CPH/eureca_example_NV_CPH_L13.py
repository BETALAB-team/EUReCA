...
def simulation(
    ...
    wall_North = Surface(
        "Wall North",
        vertices=((0., 12.3, 13.2), (0., 12.3, 15.9), (7.3, 12.3, 15.9), (7.3, 12.3, 13.2)),  # The third coordinate takes into account the flat floor number (each floor of 3.3 m - external dimensions)
        wwr=0.36,
    ...
    wall_South = Surface(
        "Wall South",
        vertices=((0., 0., 13.2), (7.3, 0., 13.2), (7.3, 0., 15.9), (0., 0., 15.9)),  # The third coordinate takes into account the flat floor number (each floor of 3.3 m - external dimensions)
        wwr=0.39,
        surface_type="ExtWall",
    ...
    roof_N = Surface(
        "Roof",
        vertices=((0., 12.3, 15.9), (0., 10.7, 15.9), (1.0, 10.7, 15.9), (1.0, 8.5, 15.9), (1.5, 8.5, 15.9), (7.3, 8.5, 15.9), (7.3, 12.3, 15.9)),
        wwr=0,
        surface_type="Roof",
    ...
    roof_S = Surface(
        "Roof",
        vertices=((0., 0., 15.9), (7.3, 0., 15.9), (7.3, 4.2, 15.9), (0., 4.2, 15.9)),
        wwr=0,
        surface_type="Roof",
        construction=roof_constr,
        window=window,
...
#########################################################
# Measure loading
measure = pd.read_csv("C:\\Users\\gecky\\OneDrive - Università degli Studi di Padova\\PhD_directory\\AAU material\\DataComfortCooling\\Collected_data\\IC-Meter-QR5B3B057D-Indoor-Minutes-01-Jun-2023-29-Oct-2023.csv",
                      skiprows = 0, header = 1, delimiter = ';', decimal = ',', index_col = 0, parse_dates = True)
measure.drop(["DATE (EUROPE/COPENHAGEN)", "TIME (EUROPE/COPENHAGEN)"], axis = 1, inplace = True)
