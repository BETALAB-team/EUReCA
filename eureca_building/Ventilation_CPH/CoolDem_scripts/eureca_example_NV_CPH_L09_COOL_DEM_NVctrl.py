...
def simulation(
    ...
    wall_North.shading_coefficient = 0.2  # The North wall faces a covered walkway in the building complex, so it is almost completely shaded
    ...
    bd = Building("L09", thermal_zones_list=[tz1], model = "1C")
