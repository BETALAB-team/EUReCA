...
def simulation(
    ...
    #     "AppSched",
    #     "dimensionless",
    #     np.array(([0.5] * 6 * ts_h + [0.8] * 1 * ts_h + [0.5] * 10 * ts_h + [0.8] * 6 * ts_h + [0.5] * 1 * ts_h) * 365)[:delay_ts],
    # )
    ...
    #     "LightSched",
    #     "dimensionless",
    #     np.array(([0] * 6 * ts_h + [0.2] * 1 * ts_h + [0] * 10 * ts_h + [0.2] * 6 * ts_h + [0] * 1 * ts_h) * 365)[:delay_ts],
    # )
    ...
    bd = Building("L20", thermal_zones_list=[tz1], model = "1C")
